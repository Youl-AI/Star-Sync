...
export const capricorn: SignContent = {
  ...
  misread: [
  ...
  ],  companions: [
    {
      title: "설명 없이 통하는 짝",
      partners: "황소자리 · 처녀자리",
      body: "같은 흙 원소라 신뢰의 화폐가 같습니다 — 말이 아니라 해낸 것. 염소자리가 존경할 수 있는 상대이고, 존경이 이 자리 애정의 형태입니다. 셋 다 쉬는 법이 서툴러서, 노는 날을 일정에 넣어야 하는 짝입니다.",
    },
    {
      title: "끌리고 부딪히는 짝",
      partners: "게자리",
      body: "밖에서 쌓는 자리와 안에서 지키는 자리입니다. 염소자리는 게자리가 만드는 온기에서 처음으로 갑옷을 벗고, 게자리는 염소자리의 어깨를 믿습니다. 성과의 언어와 마음의 언어 — 번역만 배우면 오래가는 짝입니다.",
    },
    {
      title: "서로를 단련하는 짝",
      partners: "양자리 · 천칭자리",
      body: "셋 다 여는 자리라 주도권이 겹칩니다. 염소자리의 긴 호흡이 양자리의 속도, 천칭자리의 조율과 부딪히는 날이 옵니다. 각자의 시작이 다른 계절이라는 것을 인정하면, 일 년 내내 시작할 수 있는 팀이 됩니다.",
    },
  ],
};
