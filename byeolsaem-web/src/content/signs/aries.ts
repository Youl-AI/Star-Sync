...
export const aries: SignContent = {
    opening:
    ...
    ],  companions: [
    {
      title: "설명 없이 통하는 짝",
      partners: "사자자리 · 궁수자리",
      body: "같은 불 원소라 속도를 설명할 필요가 없습니다. 셋 다 먼저 움직이고 나중에 생각하는 결이라, 함께 있으면 일이 빨리 벌어지고 후회도 빨리 잊습니다. 다만 브레이크 담당이 없다는 것이 이 짝의 유일한 약점입니다.",
    },
    {
      title: "끌리고 부딪히는 짝",
      partners: "천칭자리",
      body: "혼자 결정하는 자리와 마주 앉아야 결정되는 자리입니다. 양자리는 천칭자리의 균형 감각에서 자기에게 없는 것을 보고, 천칭자리는 양자리의 즉답에서 해방감을 느낍니다. 서로의 반대편이라 끌리고, 같은 이유로 부딪힙니다.",
    },
    {
      title: "서로를 단련하는 짝",
      partners: "게자리 · 염소자리",
      body: "셋 다 계절을 여는 자리라 각자 자기 방식으로 시작하려 합니다. 방향이 겹치면 주도권 다툼이 되지만, 역할이 갈리면 서로가 못 여는 문을 대신 열어 주는 사이가 됩니다.",
    },
  ],
};
